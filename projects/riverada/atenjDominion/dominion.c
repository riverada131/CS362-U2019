...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        cardMine(choice1, choice2, state, handPos, currentPlayer);
    ...
    case baron:
        cardBaron(choice1, state, currentPlayer);
    ...
    case minion:
        cardMinion(choice1, choice2, state, handPos, currentPlayer);
    ...
    case tribute:
        cardTribute(state, nextPlayer, currentPlayer, tributeRevealedCards);
...
{
    int j = 0, i = 0;    //used to check if player has enough cards to discard
